# :construction: :warning: Active Work Zone :warning: :construction:

# Companion notebooks for the book "Deep Learning with R"

This repository will contain the code samples that will be found in the book **Deep Learning with R, 2nd Edition (Manning Publications)** once it is published.
...
These notebooks use TensorFlow 2.7.
